...
- [grep](#grep)
	...
	- [正規表現の選択](#正規表現の選択)
	- [マッチングの制御](#マッチングの制御)
		- [e PATTERNを指定](#e-patternを指定)
		- [f FILEから1行1パターンとして読み込み](#f-fileから1行1パターンとして読み込み)
		- [i 大文字と小文字を区別しない](#i-大文字と小文字を区別しない)
		- [v マッチしない行を抜き出す](#v-マッチしない行を抜き出す)
		- [w 完全な単語にマッチ](#w-完全な単語にマッチ)
		- [x 行全体と完全にマッチしたとき](#x-行全体と完全にマッチしたとき)
	- [一般的な出力の制御](#一般的な出力の制御)
		- [c マッチした行数を表示](#c-マッチした行数を表示)
